...
const SettingsItem: React.FC<SettingsItemProps> = ({ 
  ...
  <div 
    className={`flex items-center justify-between p-4 rounded-xl cursor-pointer transition-all duration-300 hover:bg-gray-50 group ${isActive ? 'bg-blue-50 border-l-4 border-blue-500' : ''}`}
    onClick={onClick}
  >
    <div className="flex items-center gap-4">
      <div className={`p-2 rounded-lg transition-colors duration-300 ${isActive ? 'bg-blue-500 text-white' : 'bg-gray-100 text-gray-600 group-hover:bg-blue-100 group-hover:text-blue-600'}`}>
        {icon}
      </div>
      <div>
          ...
          <Modal isOpen={true} onClose={() => setModalOpen('')} title="Privacy & Security">
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div>
                  <h4 className="font-medium text-gray-900">Message Requests</h4>
                  <p className="text-sm text-gray-500">Allow message requests from everyone</p>
                </div>
                <button
                  onClick={() => updatePrivacySetting('messageRequests', !privacy.messageRequests)}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    privacy.messageRequests ? 'bg-blue-500' : 'bg-gray-300'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    privacy.activityStatus ? 'bg-blue-500' : 'bg-gray-300'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    timeSettings.breakReminders ? 'bg-blue-500' : 'bg-gray-300'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
          ...
          <Modal isOpen={true} onClose={() => setModalOpen('')} title="Your Likes">
            <div className="space-y-4">
              <div className="text-center p-6 bg-gray-50 rounded-lg">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Total Likes Given</h3>
                <p className="text-3xl font-bold text-red-500 mt-2">{activityData.totalLikes}</p>
              </div>
              <div className="space-y-3">
                <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="font-medium">View Liked Posts</div>
                  <div className="text-sm text-gray-500">See all posts you've liked</div>
                </button>
                <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="font-medium">Download Data</div>
                  <div className="text-sm text-gray-500">Export your likes history</div>
                </button>
                <button className="w-full p-3 text-left border border-red-200 rounded-lg hover:bg-red-50 transition-colors text-red-600">
                  ...
                  <div className="text-sm text-red-500">Remove all your likes (irreversible)</div>
                </button>
              </div>
            </div>
          </Modal>
          ...
          <Modal isOpen={true} onClose={() => setModalOpen('')} title="Archived Posts">
            <div className="space-y-4">
              <div className="text-center p-6 bg-gray-50 rounded-lg">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Archived Posts</h3>
              ...
              <div className="space-y-3">
                <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="text-sm text-gray-500">Browse your archived content</div>
                </button>
                <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="font-medium">Restore All</div>
                  <div className="text-sm text-gray-500">Unarchive all posts</div>
                </button>
                <button className="w-full p-3 text-left border border-red-200 rounded-lg hover:bg-red-50 transition-colors text-red-600">
                  <div className="font-medium">Delete All Archived</div>
                  <div className="text-sm text-red-500">Permanently delete archived posts</div>
                </button>
              </div>
            </div>
          </Modal>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <button
                  ...
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    appSettings.autoplay ? 'bg-blue-500' : 'bg-gray-300'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div>
                  <h4 className="font-medium text-gray-900">Use Cellular Data</h4>
                  <p className="text-sm text-gray-500">Download content using mobile data</p>
                </div>
                <button
                  onClick={() => updateAppSetting('cellularData', !appSettings.cellularData)}
                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                    appSettings.cellularData ? 'bg-blue-500' : 'bg-gray-300'
                  }`}
                >
                  <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
        ...
        <div className="mb-8">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-gray-900 placeholder-gray-500"
            />
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sticky top-6">
              ...
              <div className="mt-6 pt-6 border-t border-gray-200 space-y-2">
                <button 
                  ...
                  className="w-full text-left px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors flex items-center gap-3">
                  <HelpCircle className="w-5 h-5" />
                  Help & Support
                </button>
                <button className="w-full text-left px-4 py-3 rounded-lg text-red-600 hover:bg-red-50 transition-colors flex items-center gap-3">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                <button 
                  ...
                  <Upload className="w-6 h-6 text-gray-400 group-hover:text-blue-500 mx-auto mb-2" />
                  <div className="font-medium text-gray-900 group-hover:text-blue-600">Backup Data</div>
                </button>
                <button 
                  onClick={() => setModalOpen('export')}
                  className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-center group">
                  <Download className="w-6 h-6 text-gray-400 group-hover:text-blue-500 mx-auto mb-2" />
                ...
                <button 
                  ...
                  <RefreshCw className="w-6 h-6 text-red-400 group-hover:text-red-500 mx-auto mb-2" />
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="p-3 border border-gray-200 rounded-lg">
                  ...
                  <div className="text-sm text-gray-500 mt-1">Last comment: 2 hours ago</div>
                </div>
                <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="font-medium">View All Comments</div>
                  <div className="text-sm text-gray-500">Browse your comment history</div>
                </button>
                <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="font-medium">Download Comments</div>
                  <div className="text-sm text-gray-500">Export your comments data</div>
                </button>
              </div>
            </div>
          </Modal>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="text-sm text-gray-500">Group saved posts by topic</div>
                </button>
                <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="font-medium">View All Saved</div>
                  <div className="text-sm text-gray-500">Browse all saved content</div>
                </button>
              </div>
            </div>
          </Modal>
          ...
          <Modal isOpen={true} onClose={() => setModalOpen('')} title="Tags & Mentions">
            <div className="space-y-4">
              <div className="text-center p-6 bg-gray-50 rounded-lg">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Tagged Posts</h3>
              ...
              <div className="space-y-3">
                ...
                <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="text-sm text-gray-500">Approve or remove tags</div>
                </button>
                <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="font-medium">Tag Settings</div>
                  <div className="text-sm text-gray-500">Manage tagging preferences</div>
                </button>
              </div>
            </div>
          </Modal>
                ...
                {[1, 2, 3].map((item) => (
                  <div key={item} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">Deleted {item * 5} days ago</div>
                    </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  ...
                  <div className="text-sm text-gray-500">See what you've shared and when</div>
                </button>
                <button className="w-full p-3 text-left border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                  <div className="font-medium">Sharing Preferences</div>
                  <div className="text-sm text-gray-500">Control default sharing settings</div>
                </button>
              </div>
            </div>
          </Modal>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-500">1.8 GB</div>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-500">0.6 GB</div>
                  </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 border border-gray-200 rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-500">Download content when connected to Wi-Fi</div>
                  </div>
                ...
                <button className="w-full p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
                  ...
                  <div className="text-sm text-gray-500">Free up 142 MB</div>
                </button>
              </div>
            </div>
          </Modal>
              ...
              <div className="space-y-3">
                <div className="p-3 border border-gray-200 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="font-medium">Photos & Videos</div>
                      <div className="text-sm text-gray-500">5,247 items</div>
                    </div>
                ...
                <div className="p-3 border border-gray-200 rounded-lg">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">Settings, preferences</div>
                    </div>
                    <CheckCircle className="w-5 h-5 text-green-500" />
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg">
                  ...
                  />
                  <label htmlFor="rememberDevice" className="text-sm text-gray-700 flex-1">
                ...
                <div className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg">
                  <input 
                    ...
                    className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                  />
                  <label htmlFor="clearCache" className="text-sm text-gray-700 flex-1">
